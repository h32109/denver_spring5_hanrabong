...
auth_vue ={
	...
	join_body : ()=>{
        ...
        '            </div>'+
        '            <input type="text" class="form-control" id="cnum" placeholder="Username" required="">'+
	...
	login_body : (x)=>{
		...
		'    <input type="text" id="cid" class="form-control" placeholder="Id" required="" autofocus="">'+
	...
	mypage_body : (d)=>{
	    ...
	    '    <h1>환영합니다!</h1>'+
	        '<p class="lead">고객번호 : '+d.cnum+'<br> 고객 아이디 : '+d.cid+'</p>'+
	    '  </div>'+
